...
export const Home = () =>{
    ...
    return(
        <>
            <Header/>
            <div className="home">
                <div className='centralizarIframe'>
                    <div className='containerIframe'>
                        <iframe 
                        width="700" height="393" src="https://www.youtube.com/embed/iL4xAv9Fp5M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" className='responsive-iframe'>
                        </iframe>
                    </div>
                </div>
